...
function JnkieModule.New(Service,Identifier,Provider)
    local Junkie = loadstring(game:HttpGet("https://api.jnkie.com/api/v1/luascripts/public/6723bae098c2e46719f1d072a25538b1d3da99dfdfab07483d960fd6ab858306/download"))()
    return Junkie
end
...
function ah:RegisterAll(tabContainer)
    if not tabContainer or type(tabContainer.Tabs) ~= "table" then
        return
    end

    for TabName, Tab in pairs(tabContainer.Tabs) do
        for _, Element in ipairs(Tab.Elements or {}) do
            ...
            ah.Elements[FinalElementName] = Element
        end
    end
end
